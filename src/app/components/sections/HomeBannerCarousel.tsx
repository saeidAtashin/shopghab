...
const BANNER_SLIDES: BannerSlide[] = [
  {
    image: "/images/banner-shopghab-org.webp",
    tag: "شاپ‌قاب",
    title: "قاب",
    highlight: "اختصاصی",
    subtitle: "طراحی و چاپ قاب موبایل با کیفیت — از ایده تا درب منزل",
    chips: ["چاپ UV", "ارسال سریع", "مدل‌های متنوع"],
    href: "/create",
    label: "شروع طراحی",
    mobileLabel: "طراحی",
    align: "right",
  ...
  {
    image: "/images/banner-shopghab-2.webp",
    tag: "طراحی آماده",
    title: "صدها",
    highlight: "قالب آماده",
    subtitle: "از بین طراحی‌های آماده انتخاب کن یا قاب خودت را بساز",
    chips: ["استیکر", "متن سفارشی", "پیش‌نمایش زنده"],
    href: "/designs",
    label: "مشاهده طراحی‌ها",
    mobileLabel: "طراحی‌ها",
    align: "right",
  ...
  {
    image: "/images/banner-shopghab-3.webp",
    tag: "ارسال سریع",
    title: "تحویل",
    highlight: "به سراسر ایران",
    subtitle: "بسته‌بندی امن و ارسال سریع قاب چاپ‌شده تا درب منزل",
    chips: ["ارسال رایگان", "پیگیری سفارش", "چاپ پریمیوم"],
    href: "/create",
    label: "سفارش بده",
    mobileLabel: "سفارش",
    align: "center",
    accent: "from-cyan-300 via-sky-400 to-amber-300",
    glow: "bg-cyan-400/20",
    icon: Truck,
  },
];
