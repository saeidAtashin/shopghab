...
export default function FeatureButton({
  ...
  return (
    <motion.button
      ...
      className={`group relative cursor-pointer overflow-hidden rounded-2xl border border-border bg-white/[0.04] px-4 py-3 text-left backdrop-blur-xl ${className}`}
    >
      {/* glow hover effect */}
      ...
      <div className="relative z-10">
        <div className="text-sm font-semibold text-foreground group-hover:text-cyan-300">
          {title}
        </div>
